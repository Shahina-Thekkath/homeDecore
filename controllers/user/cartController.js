  ...
  try {
    ...
    if (!productId || !quantity) {
      return res
        ...
        .json({ error: MESSAGES.VALIDATION.INVALID_REQUEST });
    }
    ...
    if (!cart) {
      return res
        ...
        .json({ error: MESSAGES.CART.NOT_FOUND });
    }
    ...
    if (!item) {
      return res
        .status(STATUS_CODES.NOT_FOUND)
        .json({ error: MESSAGES.PRODUCT.NOT_FOUND_IN_CART });
    }
    ...
    res
      .status(STATUS_CODES.INTERNAL_SERVER_ERROR)
      .json({ error: MESSAGES.GENERIC.INTERNAL_ERROR });
  }
};
...
const addToCart = async (req, res) => {
  ...
  try {
    ...
    if (!product) {
      return res
        .status(STATUS_CODES.NOT_FOUND)
        .json({ error: MESSAGES.PRODUCT.NOT_FOUND });
    }
    ...
    if (quantity > product.quantity) {
      return res
        .status(STATUS_CODES.BAD_REQUEST)
        .json({ error: MESSAGES.CART.QUANTITY_EXCEEDS_STOCK });
    }

    if (quantity > 5) {
      return res
        .status(STATUS_CODES.BAD_REQUEST)
        .json({ error: MESSAGES.CART.MAX_QUANTITY_EXCEEDED });
    }
    ...
    if (!userId) {
      return res
        ...
        .json({ message: MESSAGES.USER.NOT_LOGGED_IN });
    }
    ...
    if (totalRequestedQty > product.quantity) {
      return res
        .status(STATUS_CODES.BAD_REQUEST)
        .json({ error: MESSAGES.PRODUCT.OUT_OF_STOCK });
    }
    ...
    return res
      .status(STATUS_CODES.INTERNAL_SERVER_ERROR)
      .json({ error: MESSAGES.GENERIC.SERVER_ERROR });
  }
};
...
const deleteCartItem = async (req, res) => {
  try {
    ...
    return res
      ...
      .json({
        success: true,
        message: MESSAGES.CART.ITEM_DELETED,
